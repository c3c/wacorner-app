				...
				<?php if($robos->count() != 0): ?>
						...
						<tr>
							...
							<?php else: ?>
								<td>
									...
									<?php if($robo->nome != "Funil WAcorner"): ?>
                                        <a href="<?php echo e(route('robos.edit',['id' => $robo->id])); ?>" class="btn btn-warning">Configurar</a>
                                        <a href="<?php echo e(route('robos.send.list',['id' => $robo->id,'data' => date('Y-m-d')])); ?>" class="btn btn-info">Lista de hoje</a>
                                        <a href="<?php echo e(route('robos.send.list',['id' => $robo->id,'data' => date('Y-m-d', strtotime('+1 days')) ])); ?>" class="btn btn-info">Lista de amanhã</a>
                                    <?php endif; ?>
                                </td>
							<?php endif; ?>
						</tr>
                    ...
                    <?php if(!isset($achou)): ?>
                        <tr>
                            ...
                            <td>Desativado</td>
                            <td><a href="<?php echo e(route('robos.alterar.status',['id' => -1])); ?>" class="btn btn-primary">Ativar</a></td>
                        </tr>
                    <?php endif; ?>
				<?php else: ?>
					<tr>
