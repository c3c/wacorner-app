...
<div class="box">
	...
	<div class="box-body">
        ...
        <?php if($profissional != true): ?>
			<div class="col-md-6">
                <form-paypal profissional="<?php echo e($profissional); ?>" url_obrigado_profissional="<?php echo e(route('venda.paypal.new',['plano' => 'profissional'])); ?>" email="<?php echo e(auth()->user()->email); ?>"></form-paypal>
