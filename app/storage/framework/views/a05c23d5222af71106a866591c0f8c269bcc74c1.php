    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <?php endif; ?>
                ...
                <div class="navbar-custom-menu">
                    ...
                    <ul class="nav navbar-nav">
                        <notifications url="<?php echo e(route('notifications')); ?>"></notifications>
                        <li><a href="<?php echo e(route('lista')); ?>"><i class="fa fa-fw fa-list"></i></a></li>
                        <li><a href="<?php echo e(route('usuario.perfil')); ?>"><i class="fa fa-fw fa-user"></i></a></li>
                        <li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <?php echo $__env->make('admin.includes.admin_menus', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </section>
