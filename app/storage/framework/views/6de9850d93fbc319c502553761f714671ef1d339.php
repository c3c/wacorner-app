...
<div class="box">
	...
	<div class="box-body">
        ...
        <?php if($basico != true || $profissional != true): ?>
			<div class="col-md-6">
                <form-paypal basico="<?php echo e($basico); ?>" profissional="<?php echo e($profissional); ?>" url_obrigado_basico="<?php echo e(route('venda.paypal.new',['plano' => 'basico'])); ?>" url_obrigado_profissional="<?php echo e(route('venda.paypal.new',['plano' => 'profissional'])); ?>" email="<?php echo e(auth()->user()->email); ?>"></form-paypal>
