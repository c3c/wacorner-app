		                ...
		                <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                ...
			                <tr>
			                  	...
			                  	<td>
			                  		...
			                  		<a href="<?php echo e(route('usuario.perfil.id',['id' => $usuario->id])); ?>" class="btn btn-warning btn-xs">Editar perfil</a>
			                  		<a href="<?php echo e(route('usuario.excluir',['id' => $usuario->id])); ?>" onclick="return confirm('Tem certeza que deseja EXCLUIR conta?')" class="btn btn-danger btn-xs">Excluir conta</a>
			                  	</td>
